...
{
    /// <summary>
    /// Specifies converter from <see cref="PatientName"/> into JSON.
    /// </summary>
    internal class PatientNameJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        public override void WriteJson([NotNull] JsonWriter writer, [NotNull] object value, [NotNull] JsonSerializer serializer)
        {
            ...
            var patientName = (PatientName)value;
            serializer.Serialize(writer, patientName.DicomString);
        }
        ...
        public override object ReadJson([NotNull] JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            return new PatientName(value?.ToString() ?? string.Empty);
        }
